...
def Card():
 label_id['text']=510152045
 label_name['text']="Christian Elliott"
 label_dob['text']="24 october 2004"
 label_pin['text']="402331"
 label_address['text']="Lorepark 355b,Antwerpen, Belgium"
 label_vehicle_type['text']="Audi A3"
    
    
button1=Button(root,text="show driving licence",command=Card)
